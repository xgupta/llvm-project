...
DIDerivedType *DIBuilder::createDynamicType(DIType *BTy, DIExpression *Location,
  ...
  return DIDerivedType::get(
      VMContext, dwarf::DW_TAG_dynamic_type, "", nullptr, 0, nullptr, BTy, 0, 0,
      0, std::nullopt, std::nullopt, DINode::FlagZero, nullptr /*ExtraData*/,
      nullptr /*Annotations*/, Location, Allocated);
}
