...
private:
  ...
  getImpl(LLVMContext &Context, unsigned Tag, StringRef Name, Metadata *File,
          ...
          uint32_t NumExtraInhabitants, DIFlags Flags, VendorDIFlags VFlags,
...
public:
  DEFINE_MDNODE_GET(
      ...
      (Tag, Name, File, Line, Scope, BaseType, SizeInBits, AlignInBits,
       OffsetInBits, Specification, NumExtraInhabitants, Flags,
       VendorDIFlagZero, Elements, RuntimeLang, VTableHolder, TemplateParams,
  ...
  DEFINE_MDNODE_GET(
      ...
      (unsigned Tag, StringRef Name, DIFile *File, unsigned Line,
       ...
       uint32_t NumExtraInhabitants = 0),
      (Tag, Name, File, Line, Scope, BaseType, SizeInBits, AlignInBits,
       OffsetInBits, Specification, NumExtraInhabitants, Flags, VFlags,
  ...
  DEFINE_MDNODE_GET(
      ...
      (unsigned Tag, MDString *Name, Metadata *File, unsigned Line,
       ...
       Metadata *DataLocation = nullptr, Metadata *Associated = nullptr,
       Metadata *Allocated = nullptr, Metadata *Rank = nullptr,
       Metadata *Annotations = nullptr, Metadata *Specification = nullptr,
       uint32_t NumExtraInhabitants = 0),
      (Tag, Name, File, Line, Scope, BaseType, SizeInBits, AlignInBits,
