...
private:
  ...
  static DIBasicType *getImpl(LLVMContext &Context, unsigned Tag,
    ...
    return getImpl(Context, Tag, getCanonicalMDString(Context, Name), nullptr,
                   ...
                   Flags, std::nullopt, Storage, ShouldCreate);
  }
  static DIBasicType *getImpl(LLVMContext &Context, unsigned Tag,
    ...
    return getImpl(Context, Tag, Name, nullptr, SizeInBits, AlignInBits,
                   Encoding, NumExtraInhabitants, Flags, std::nullopt, Storage,
                   ShouldCreate);
  }
  static DIBasicType *getImpl(LLVMContext &Context, unsigned Tag,
                              MDString *Name, uint64_t SizeInBits,
                              ...
                              StorageType Storage, bool ShouldCreate = true) {
    return getImpl(Context, Tag, Name, nullptr, SizeInBits, AlignInBits,
                   Encoding, NumExtraInhabitants, Flags, DecimalAttrInfo,
  ...
  static DIBasicType *getImpl(LLVMContext &Context, unsigned Tag,
    ...
    return getImpl(Context, Tag, getCanonicalMDString(Context, Name),
                   PictureString, SizeInBits, AlignInBits, Encoding,
                   NumExtraInhabitants, Flags, DecimalAttrInfo, Storage,
                   ShouldCreate);
  }
  ...
  TempDIBasicType cloneImpl() const {
    return getTemporary(getContext(), getTag(), getName(),
                        ...
                        getNumExtraInhabitants(), getFlags(), getDecimalInfo());
  }
...
public:
  ...
  DEFINE_MDNODE_GET(DIBasicType,
                    ...
                    (Tag, Name, SizeInBits, 0, 0, 0, FlagZero, std::nullopt))
  DEFINE_MDNODE_GET(DIBasicType,
                    (unsigned Tag, StringRef Name, uint64_t SizeInBits,
  ...
  DEFINE_MDNODE_GET(DIBasicType,
                    (unsigned Tag, StringRef Name, MDString *PictureString,
                     uint64_t SizeInBits, uint32_t AlignInBits,
                     unsigned Encoding, uint32_t NumExtraInhabitants,
                     DIFlags Flags, std::optional<DecimalInfo> ExtInfo),
                    (Tag, Name, PictureString, SizeInBits, AlignInBits,
                     Encoding, NumExtraInhabitants, Flags, ExtInfo))
  DEFINE_MDNODE_GET(DIBasicType,
...
private:
  ...
  TempDIDerivedType cloneImpl() const {
    return getTemporary(
        ...
        getAnnotations(), getLocation(), getAllocated());
  }
...
public:
  DEFINE_MDNODE_GET(
      ...
      (Tag, Name, File, Line, Scope, BaseType, SizeInBits, AlignInBits,
       ...
       Annotations, Location, Allocated))
  ...
  /// Get location expression associated with this derived type.
  ///
...
private:
  ...
  getImpl(LLVMContext &Context, unsigned Tag, StringRef Name, Metadata *File,
    ...
    return getImpl(
        ...
        BaseType, SizeInBits, AlignInBits, OffsetInBits, Flags, VFlags,
        Elements.get(), RuntimeLang, VTableHolder, TemplateParams.get(),
        getCanonicalMDString(Context, Identifier), Discriminator, DataLocation,
        Associated, Allocated, Rank, Annotations.get(), Specification, NumExtraInhabitants,
        Storage, ShouldCreate);
  }
  static DICompositeType *
  getImpl(LLVMContext &Context, unsigned Tag, MDString *Name, Metadata *File,
          unsigned Line, Metadata *Scope, Metadata *BaseType,
          uint64_t SizeInBits, uint32_t AlignInBits, uint64_t OffsetInBits,
          DIFlags Flags, VendorDIFlags VFlags, Metadata *Elements,
          unsigned RuntimeLang, Metadata *VTableHolder,
          Metadata *TemplateParams, MDString *Identifier,
          Metadata *Discriminator, Metadata *DataLocation, Metadata *Associated,
          Metadata *Allocated, Metadata *Rank, Metadata *Annotations,  Metadata *Specification,
          uint32_t NumExtraInhabitants,
          StorageType Storage, bool ShouldCreate = true);
  ...
  TempDICompositeType cloneImpl() const {
    return getTemporary(
        getContext(), getTag(), getName(), getFile(), getLine(), getScope(),
        getBaseType(), getSizeInBits(), getAlignInBits(), getOffsetInBits(),
        getFlags(), getVendorDIFlags(), getElements(), getRuntimeLang(),
...
public:
  DEFINE_MDNODE_GET(
      ...
      (Tag, Name, File, Line, Scope, BaseType, SizeInBits, AlignInBits,
       OffsetInBits, Specification, NumExtraInhabitants, Flags, VendorDIFlagZero, Elements, RuntimeLang,
  ...
  DEFINE_MDNODE_GET(
      ...
      (unsigned Tag, StringRef Name, DIFile *File, unsigned Line,
       ...
       uint32_t NumExtraInhabitants = 0),
      (Tag, Name, File, Line, Scope, BaseType, SizeInBits, AlignInBits,
       OffsetInBits, Specification, NumExtraInhabitants, Flags, VFlags, Elements, RuntimeLang, VTableHolder,
